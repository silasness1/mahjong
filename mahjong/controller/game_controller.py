...
class GameController: 
    """Runs the game loop using the `model` components. Handles communication between `model` and `view` """
    ...
    def start(
        ...
        if input_settings:
            game = GameMaster(self.survey_player_settings(), wait_on_end=wait_on_end)
        else:
